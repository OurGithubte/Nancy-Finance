...
export function createRecurringCronHandler(processor: () => Promise<any>) {
...
export const GET = createRecurringCronHandler(() => automationService.processDueRecurringTransactions());
