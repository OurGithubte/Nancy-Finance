...
const VALID_PERIOD_TYPES: ReportPeriodType[] = ["this_month", "last_month", "last_3_months", "last_6_months", "this_year", "custom"];
...
export default async function ReportsPage({
  ...
  const periodType: ReportPeriodType = VALID_PERIOD_TYPES.includes(rawPeriod as ReportPeriodType)
    ? (rawPeriod as ReportPeriodType)
    : "this_month";
  const customFrom = resolvedParams.from as string | undefined;
  const customTo = resolvedParams.to as string | undefined;
  ...
  return (
    <div className="space-y-6">
      ...
      {periodError && (
        <div className="mb-6 flex items-center gap-2 rounded-xl border border-expense/30 bg-expense/5 px-4 py-3 text-xs font-medium text-expense">
          <AlertCircle className="h-4 w-4 shrink-0" />
          <span>{periodError} Đang hiển thị dữ liệu tháng này thay thế.</span>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <FinanceKpiCard
          ...
          growth={comparison.incomeChange}
        ...
        <FinanceKpiCard
          ...
          growth={comparison.expenseChange}
        ...
        <FinanceKpiCard
          ...
          growth={comparison.netCashflowChange}
